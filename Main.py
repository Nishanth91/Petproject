...
if selected == "Regions":
  ...
  if choice == 'Provinces':
      ...
      with tab10:
          ...
          with col1:
            st.image("https://upload.wikimedia.org/wikipedia/commons/thumb/d/dd/Flag_of_Newfoundland_and_Labrador.svg/1920px-Flag_of_Newfoundland_and_Labrador.svg.png",width=550)
          with col2:            
